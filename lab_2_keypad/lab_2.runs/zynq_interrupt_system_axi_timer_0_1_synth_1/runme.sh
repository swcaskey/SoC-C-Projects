...
HD_PWD='/home/user/Desktop/lab_2/lab_2.runs/zynq_interrupt_system_axi_timer_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_interrupt_system_axi_timer_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_interrupt_system_axi_timer_0_1.tcl
