...
HD_PWD='/home/user/Desktop/lab_0/lab_0.runs/PmodIPs_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PmodIPs_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PmodIPs_rst_ps7_0_100M_0.tcl
