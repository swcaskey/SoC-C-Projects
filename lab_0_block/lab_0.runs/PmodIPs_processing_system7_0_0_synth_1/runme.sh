...
HD_PWD='/home/user/Desktop/lab_0/lab_0.runs/PmodIPs_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PmodIPs_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PmodIPs_processing_system7_0_0.tcl
