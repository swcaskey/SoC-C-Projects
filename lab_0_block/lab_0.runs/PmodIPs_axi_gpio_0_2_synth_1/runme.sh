...
HD_PWD='/home/user/Desktop/lab_0/lab_0.runs/PmodIPs_axi_gpio_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PmodIPs_axi_gpio_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PmodIPs_axi_gpio_0_2.tcl
